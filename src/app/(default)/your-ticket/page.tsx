      ...
      <div className="tickets-container grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 p-6">
        {bookings &&
          bookings.map((data, index) => (
            ...
            //           </g>
            //         </svg>
            //         <strong className="text-2xl uppercase">{data.name}</strong>
            //       </div>
            //     </div>
            //     <div className="front">
            //       <div className="img">
            ...
            //           <small className="badge uppercase">Seat :  {data.seatPreference}</small>
            //           <div className="title">
            //             <p className="title">
            //               <strong className="text-2xl  uppercase">{data.name}</strong>
            //             </p>
            //           </div>
            //           <p className="card-footer">Date : {data.date}</p>
            //           <p className="card-footer">Time : {data.time}</p>
            //           <p className="card-footer">Contact : {data.contact}</p>
            //           {/* <button onClick={()=>{
            //             deleteBooking(data._id)
            //           }}>hello</button> */}
            //           <Button onClick={() => deleteBooking(data._id)}/>
            //         </div>
            //       </div>
            //     </div>
            //   </div>
            ...
            <div key={index} className="brutalist-card">
              <div className="brutalist-card__header">
                <div className="brutalist-card__icon uppercase">
                  {data.seatPreference}
                </div>
                <div className="brutalist-card__alert">{data.name}</div>
              </div>
              ...
              <div className="brutalist-card__actions">
                <button className="brutalist-card__button brutalist-card__button--read" onClick={() => deleteBooking(data._id)}>Cancel</button>
              </div>
            </div>
          ))}
      </div>
